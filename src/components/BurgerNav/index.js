...
const pages = [
  ...
  {title: 'Resume', url: 'https://docdro.id/Jzi0d4C', isExternalLink: true}
];
    ...
    <AppBar position="static" sx={{backgroundColor: 'black'}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <a href="https://www.linkedin.com/in/austin-fanger-3947a212b//"
                        target="_blank"
                        rel="noreferrer"
                    >
                <Avatar alt="Austin" src={LinkedIn} sx={{ width: 40, height: 40 }} />
          </a>
