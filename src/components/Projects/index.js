...
import workout from "../../assets/linkedIn/workout.jpg"
...
const particlesLoaded = useCallback(async container => {
  ...
  return (
    ...
    <div style={{display: "flex", gap: "10px", justifyContent: "center", marginTop: "15px", marginBottom: "100px"}}>
      ...
      link= "https://github.com/Afang911/WeatherForcast"     
      />
      <ProjectCard 
      img={Scheduler}
      ...
      link= "https://github.com/Afang911/Calendar-Scheduler"     
      />
      <ProjectCard 
      img={Quiz}
      title= "Coding Quiz"
      ...
      Technologies used: Javascript, HTML, CSS`}
      link= "https://github.com/Afang911/Timed-Quiz"     
      />
    </div>
    ...
    <div style={{display: "flex", gap: "10px", justifyContent: "center", marginTop: "15px", marginBottom: "100px"}}>
      ...
      img={workout}
      title= ""
      text= {`MERN full-stack application that allows customers to login and browse for workouts filtered by muscle groups. They can also save their exercises to make a customized workout. 

      Technologies used: MongoDB, Express, React, Node, Heroku`}
      link= "https://github.com/Afang911/Workout-Customizer"     
      />
      <ProjectCard 
      img={Book}
      ...
      link= "https://github.com/Afang911/BookSearch"     
      />
    </div>
    ...
    <div style={{display: "flex", gap: "10px", justifyContent: "center", marginTop: "15px", marginBottom: "100px"}}>
      ...
      link= "https://github.com/Afang911/Employee-Tracker"     
      />
      <BackCard 
      ...
      link= "https://github.com/Afang911/ECommerce"     
      />
      <BackCard 
      ...
      link= "https://github.com/Afang911/NoSQL-API"     
      />
      </div>
